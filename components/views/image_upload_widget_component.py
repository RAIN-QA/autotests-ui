...
class ImageUploadWidgetComponent(BaseComponent):
    def __init__(self, page: Page, identifier: str):
        ...
        self.image_upload_info_icon = Icon(page,f'{identifier}-image-upload-widget-info-icon', "Image upload icon")
        self.image_upload_info_title = Text(page,f'{identifier}-image-upload-widget-info-title-text', "Image upload title")
        self.image_upload_info_description = Text(
            page,'create-course-preview-image-upload-widget-info-description-text', "Image upload description"
        )
